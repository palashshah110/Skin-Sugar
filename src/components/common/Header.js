...
export default function Header() {
  ...
  const menuItem = [{ name: 'home', route: "/" }, { name: 'products', route: "/products" }, { name: 'Personalized Hampers', route: "/basket-selection" }, { name: 'faq', route: "/faq" }, { name: 'contact', route: "/contact" }];
  return (
